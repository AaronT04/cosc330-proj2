...
/*
    ...
    public void AddEllipse(View view){
        ...
        float cooldown=Float.valueOf(coolEdit.getText().toString());//enter
        Float height=10f;
        Line startLine=new Line(new Range(0,DisplaySize.screenWidth/2f),new Range(DisplaySize.screenHeight+1,DisplaySize.screenHeight+1));
        Line endLine=new Line(new Range(DisplaySize.screenWidth/2f,DisplaySize.screenWidth/2f),new Range(DisplaySize.screenHeight/2f,0));
